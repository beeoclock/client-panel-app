...
@Component({
	...
	template: `
			...
			@if (labelOfDragAndDropZone().classList.contains('fileover')) {

				<p class="mb-2 text-sm dark:text-beeColor-400 font-bold">
...
export class PlaceholderImageComponent {
	...
	public readonly labelOfDragAndDropZone = input.required<HTMLElement>();
