...
import {WhacAMoleContainer} from "@shared/presentation/whac-a-mole/whac-a-mole.container";
...
export class WhacAMole extends Reactive implements OnInit {
	...
	@HostBinding()
	public class =
		'not-tablet:animate-slideOut hidden tablet:hidden w-full not-tablet:!w-0 absolute top-0 right-0 h-screen z-[100] bg-black/50 flex justify-end lg:min-w-[375px] lg:max-w-[375px] lg:relative';
