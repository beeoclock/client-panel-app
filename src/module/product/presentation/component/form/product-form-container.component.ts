...
import { ClientState } from '@src/module/client/state/client/client.state';
import { ProductForm } from '@src/module/product/domain/model/product.form';
import { ProductActions } from '@src/module/product/state/product/product.actions';
import { CardComponent } from '@src/module/utility/presentation/component/card/card.component';
import { ButtonSaveContainerComponent } from '@src/module/utility/presentation/component/container/button-save/button-save.container.component';
import { FormInputComponent } from '@src/module/utility/presentation/component/input/form.input.component';
import { IonSelectTagsComponent } from '@src/module/utility/presentation/component/input/ion/ion-select-tags.component';
import { PriceAndCurrencyComponent } from '@src/module/utility/presentation/component/input/price-and-currency.component';
import { SwitchActiveBlockComponent } from '@src/module/utility/presentation/component/switch/switch-active/switch-active-block.component';
import { PrimaryButtonDirective } from '@src/module/utility/presentation/directives/button/primary.button.directive';
import { DefaultLabelDirective } from '@src/module/utility/presentation/directives/label/default.label.directive';
