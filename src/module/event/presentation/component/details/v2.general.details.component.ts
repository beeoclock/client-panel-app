			...
			<dl class="divide-y divide-gray-100">
				<div class="p-2">
					...
					<dd class="mt-2 text-sm text-gray-900 ">
						<ul role="list" class="divide-y divide-gray-100 rounded-md border-2 border-gray-200"
							[style.border-color]="event.originalData.service.serviceSnapshot.presentation.color">
							<li class="flex">
								<img
