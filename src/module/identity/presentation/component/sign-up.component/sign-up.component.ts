...
<!--    </form>-->
    ...
    <form [formGroup]="form" class="space-y-6" action="#" method="POST">
      <div>
        <label for="displayName" class="block text-sm font-medium leading-6 text-grey-900 dark:text-white">
      ...
      <div>
        <label for="email" class="block text-sm font-medium leading-6 text-grey-900 dark:text-white">
