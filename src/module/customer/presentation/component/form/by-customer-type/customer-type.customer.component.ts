...
import {
	UnknownCustomerTypeCustomerComponent
} from "@customer/presentation/component/form/by-customer-type/unknown.customer-type.customer.component";
import {
...
@Component({
	...
	template: `
		...
		<ng-container [ngSwitch]="form.value.customerType">
			...
			<ng-content *ngSwitchCase="customerTypeEnum.unknown" select="[slot='banner'][customer-type='unknown']"/>
			<ng-content *ngSwitchCase="customerTypeEnum.unregistered" select="[slot='banner'][customer-type='unregistered']"/>
			...
			<app-unknown-customer-type-customer [form]="form" *ngSwitchCase="customerTypeEnum.unknown"/>
