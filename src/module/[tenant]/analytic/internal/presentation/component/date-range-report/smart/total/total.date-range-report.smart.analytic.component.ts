...
} from "@analytic/internal/store/date-range-report/date-range-report.analytic.state";
...
} from "@analytic/internal/store/date-range-report/date-range-report.analytic.actions";
import {
	CardOverviewComponent
} from "@analytic/internal/presentation/component/date-range-report/dummy/overview-total/card/card.overview.component";
import {
	CustomerListGroupComponent
} from "@analytic/internal/presentation/component/date-range-report/dummy/customer-list-group/customer-list-group.component";
