...
import {CreatePaymentApiAdapter} from "@payment/external/adapter/api/create.payment.api.adapter";
import {UpdatePaymentApiAdapter} from "@payment/external/adapter/api/update.payment.api.adapter";
import {DetailsPaymentApiAdapter} from "@payment/external/adapter/api/details.payment.api.adapter";
import {DeletePaymentApiAdapter} from "../../external/adapter/api/delete.payment.api.adapter";
import {PagedPaymentApiAdapter} from "@payment/external/adapter/api/paged.payment.api.adapter";
import {IPaymentDto} from "@payment/domain/interface/dto/i.payment.dto";
import {PaymentActions} from "@payment/state/payment/payment.actions";
