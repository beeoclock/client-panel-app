...
export class PatchMediaBannersClientApiAdapter extends BaseApiAdapter<unknown> {
	...
	public override execute$(body: unknown) {
		return this.httpClient.patch<unknown>(clientMediaEndpointEnum.patchBanners, body);
	}
