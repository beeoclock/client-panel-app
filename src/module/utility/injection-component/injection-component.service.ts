...
export class InjectionComponentService {
  ...
  public appendComponent<T>(
    ...
    const componentRef: ComponentRef<any> = this.getComponentRefAndAssignDataAndRegisterToAppView<T>(componentClass, options, projectableNodes, rootSelectorOrNode, ngModule);
