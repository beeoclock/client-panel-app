...
export class WhacAMoleWrapper<COMPONENT> {
	...
	@HostBinding()
	public class = 'flex flex-col h-[calc(100vh-64px)] md:h-screen';
	...
	public renderComponent(component: Type<COMPONENT>, inputs?: Record<string, unknown>) {
		...
		componentRef.location.nativeElement.classList.add('h-[calc(100vh-64px)]', 'md:h-screen', 'overflow-y-auto');
