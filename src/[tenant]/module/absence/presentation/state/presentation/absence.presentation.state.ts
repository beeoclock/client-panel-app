...
export class AbsencePresentationState {
	...
	public async closeDetailsAction() {
		...
		const {AbsenceDetailsContainerComponent} = await import("@absence/presentation/ui/component/details/absence-details-container.component");
	...
	public async closeFormAction() {
		...
		const {AbsenceFormContainerComponent} = await import("@absence/presentation/ui/component/form/absence-form-container.component");
	...
	public async updateOpenedDetailsAction(ctx: StateContext<IAbsenceState>, {payload}: AbsencePresentationActions.UpdateOpenedDetails) {
		...
		import("@absence/presentation/ui/component/details/absence-details-container.component")
