...
import {DateRangeReportAnalyticApi,} from "@analytic/infrastructure/api/adapter/date-range-report.analytic.api.adapter";
import {
...
import {transformIResponseToAnalytic} from "@analytic/domain/tool/calculate.date-range-report.analytic.tool";
...
import {Analytic} from "@analytic/infrastructure/store/date-range-report/interface/i.analytic";
