...
} from "@tenant/member/member/infrastructure/data-source/api/media/patch.member-media.api.adapter";
import {RESPONSE_IMemberMedia} from "@tenant/member/member/domain/interface/i.member-media";
import {AvatarFormComponent} from "@tenant/member/member/presentation/component/form/avatar-form/avatar-form.component";
