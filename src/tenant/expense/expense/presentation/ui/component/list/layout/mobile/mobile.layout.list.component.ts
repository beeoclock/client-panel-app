...
import {CardListComponent} from "@tenant/expense/expense/presentation/ui/component/list/card/card.list.component";
...
@Component({
	selector: 'expense-mobile-layout-list-component',
