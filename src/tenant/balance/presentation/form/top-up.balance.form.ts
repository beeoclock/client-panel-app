...
export class TopUpBalanceForm extends BaseEntityForm<'CustomerDto', ICustomerForm> {
	...
	public static create(initValue: Partial<ICustomer.EntityRaw> = {}): TopUpBalanceForm {
