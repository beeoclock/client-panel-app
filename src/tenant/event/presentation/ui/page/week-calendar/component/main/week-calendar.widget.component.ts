...
export class WeekCalendarWidgetComponent implements OnInit, AfterViewInit {
	...
	public readonly weekdays = [
		{ number: '1', translationKey: 'calendar.weekdays.monday' },
		{ number: '2', translationKey: 'calendar.weekdays.tuesday' },
		{ number: '3', translationKey: 'calendar.weekdays.wednesday' },
		{ number: '4', translationKey: 'calendar.weekdays.thursday' },
		{ number: '5', translationKey: 'calendar.weekdays.friday' },
		{ number: '6', translationKey: 'calendar.weekdays.saturday' },
		{ number: '7', translationKey: 'calendar.weekdays.sunday' }
	];
