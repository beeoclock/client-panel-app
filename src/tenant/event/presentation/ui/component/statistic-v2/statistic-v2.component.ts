...
} from "@tenant/event/presentation/ui/component/statistic-v2/components/diagrams/total-revenue/total-revenue.diagram.component";
import {
	OrdersCounterStatisticComponent
} from "@tenant/event/presentation/ui/component/statistic-v2/components/table/total/counter/orders.counter.statistic.component";
import {
	OrderServicesCounterStatisticComponent
} from "@tenant/event/presentation/ui/component/statistic-v2/components/table/total/counter/order-services.counter.statistic.component";
import {
	CustomersCounterStatisticComponent
} from "@tenant/event/presentation/ui/component/statistic-v2/components/table/total/counter/customers.counter.statistic.component";
import {
	ServicesCounterStatisticComponent
} from "@tenant/event/presentation/ui/component/statistic-v2/components/table/total/counter/services.counter.statistic.component";
import {
