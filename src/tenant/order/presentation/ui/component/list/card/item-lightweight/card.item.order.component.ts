					...
					<div class="flex flex-col cursor-pointer" (click)="singleClick()">
						...
						@for (group of groups(); track group.date) {
							<div class="w-full  bg-[#FFFFFF] rounded-t-[20px]">
								...
								@for (service of group.services; track service._id) {
...
export class CardItemLightweightOrderComponent {
	...
	public readonly groups = computed(() => this.cardItemOrderService.groupBySpecialist(this.orderDto().services));
