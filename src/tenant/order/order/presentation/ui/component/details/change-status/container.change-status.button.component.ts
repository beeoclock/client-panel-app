...
} from "@tenant/order/order/presentation/ui/component/details/change-status/buttons/cancelled.change-status.button.component";
import {
	ConfirmedChangeStatusButtonComponent
} from "@tenant/order/order/presentation/ui/component/details/change-status/buttons/confirmed.change-status.button.component";
import {
	DoneChangeStatusButtonComponent
} from "@tenant/order/order/presentation/ui/component/details/change-status/buttons/done.change-status.button.component";
import {
	RejectedChangeStatusButtonComponent
} from "@tenant/order/order/presentation/ui/component/details/change-status/buttons/rejected.change-status.button.component";
