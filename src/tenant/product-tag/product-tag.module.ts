...
import {ApiDataProvider} from "@tenant/product-tag/infrastructure/data-provider/api.data-provider";
import {SyncManager} from "@tenant/product-tag/infrastructure/sync-manager/sync-manager";
import {NgxsModule} from "@ngxs/store";
import {PushChangesSyncManager} from "@tenant/product-tag/infrastructure/sync-manager/push.changes.sync-manager";
import {SharedUow} from "@core/shared/uow/shared.uow";
import {
	ArchiveProductTagApiAdapter
} from "@tenant/product-tag/infrastructure/data-source/api/archive.product-tag.api.adapter";
import {
...
} from "@tenant/product-tag/infrastructure/data-source/api/delete.product-tag.api.adapter";
import {
...
} from "@tenant/product-tag/infrastructure/data-source/api/unarchive.product-tag.api.adapter";
import {
...
} from "@tenant/product-tag/infrastructure/data-provider/indexedDB/product-tag.indexedDB.data-provider";
import {
	ProductTagDexieAdapterIndexedDBDataProvider
} from "@tenant/product-tag/infrastructure/data-provider/indexedDB/adapter/product-tag.dexie.adapter.indexedDB.data-provider";
import {ProductTagRepository} from "@tenant/product-tag/infrastructure/repository/product-tag.repository";
...
} from "@tenant/product-tag/infrastructure/state/presentation/product-tag.presentation.state";
