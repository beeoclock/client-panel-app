...
import {IMember} from "@src/identity/module/identity/domain/interface/i.member";
import {memberContextEndpointEnum} from "@src/identity/module/identity/infrastructure/endpoint/member-context.endpoint";
